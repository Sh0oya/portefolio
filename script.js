...
(() => {
    ...
    const i18n = {
        ...
        'la1.cat': { en: 'Cases and Tools', fr: 'Cas et outils' },
        'la1.date': { en: 'Jul 20, 2026', fr: '20 juillet 2026' },
        'la1.title': { en: 'What a custom CRM really changes: the 3018 case', fr: 'Ce qu\'un CRM sur mesure change vraiment : le cas 3018' },
        'la1.lead': { en: 'French helpline 3018 replaced its off-the-shelf CRM with Emma, a custom tool: one multichannel queue, prioritised urgencies, hosted in France.', fr: 'Le 3018 a remplacé son CRM du marché par Emma, un outil sur mesure : file unique multicanale, urgences priorisées, hébergement en France.' },
        'la2.cat': { en: 'Regulation', fr: 'Régulation' },
        'la2.date': { en: 'Jul 19, 2026', fr: '19 juillet 2026' },
        'la2.title': { en: 'EU forces Google to open Android to rival AI agents', fr: 'L\'UE force Google à ouvrir Android aux agents IA rivaux' },
        'la2.lead': { en: 'On July 16, 2026, the EU ordered Google to open 11 Android features to rival AI assistants, on par with Gemini. Why distribution is the real fight.', fr: 'Le 16 juillet 2026, l\'UE a ordonné à Google d\'ouvrir 11 fonctions d\'Android aux assistants IA rivaux, au même niveau que Gemini. Ce que ça change.' },
        'la3.cat': { en: 'Data & Analytics', fr: 'Data & Analytics' },
        'la3.date': { en: 'Jul 19, 2026', fr: '19 juillet 2026' },
        'la3.title': { en: 'SAP bets $1.16bn on tabular AI, not another LLM', fr: 'SAP boucle Prior Labs : le pari de l\'IA tabulaire' },
        'la3.lead': { en: 'On July 17, 2026, SAP closed its Prior Labs acquisition and is investing over €1 billion in tabular AI, built to predict on structured business data.', fr: 'Le 17 juillet 2026, SAP a bouclé le rachat de Prior Labs et investit plus d\'un milliard d\'euros dans l\'IA tabulaire, taillée pour les données métier structurées.' },
