...
(() => {
    ...
    const i18n = {
        ...
        'la1.cat': { en: 'Applied AI', fr: 'IA appliquée' },
        'la1.date': { en: 'Jul 24, 2026', fr: '24 juillet 2026' },
        'la1.title': { en: 'OpenAI Presence: AI Agents Move Into Production', fr: 'OpenAI Presence : les agents IA passent en production' },
        'la1.lead': { en: 'OpenAI launches Presence, an enterprise AI agent platform: 75% of support calls resolved without a human. What it means for small and mid-sized companies.', fr: 'OpenAI lance Presence, plateforme d\'agents IA pour grands comptes : 75 % des appels résolus sans humain. Ce que ça change pour une PME française.' },
        'la2.cat': { en: 'Guides & Pricing', fr: 'Guides & prix' },
        'la2.date': { en: 'Jul 23, 2026', fr: '23 juillet 2026' },
        'la2.title': { en: 'How much does a custom CRM cost in 2026?', fr: 'Combien coûte un CRM sur mesure en 2026 ?' },
        'la2.lead': { en: 'A custom CRM costs €8,000-€25,000 for a V1, €30,000-€100,000 to replace an off-the-shelf tool in 2026. Tables, sources and when it is worth it.', fr: 'Un CRM sur mesure coûte de 8 000 à 25 000 € pour une V1, 30 000-100 000 € pour remplacer un outil du marché en 2026. Tableaux, sources et quand ça vaut le coup.' },
        'la3.cat': { en: 'Regulation', fr: 'Régulation' },
        'la3.date': { en: 'Jul 21, 2026', fr: '21 juillet 2026' },
        'la3.title': { en: 'EU AI Act, August 2, 2026: what applies to your SME', fr: 'AI Act 2 août 2026 : ce qui s\'applique à votre PME' },
        'la3.lead': { en: 'The Digital Omnibus pushes the AI Act\'s high-risk rules to late 2027. What actually applies to an SME on August 2, 2026: AI transparency and AI literacy.', fr: 'Le Digital Omnibus repousse l\'AI Act haut risque à fin 2027. Ce qui s\'applique vraiment à votre PME le 2 août 2026 : transparence IA et littératie.' },
