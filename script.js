...
(() => {
    ...
    const i18n = {
        ...
        'bento5.t5':      { en: 'Integrations', fr: 'Intégrations' },
        'bento5.d5':      { en: 'APIs, webhooks, data sync — everything plugged into your existing stack, without breaking anything.', fr: 'API, webhooks, data sync — tout est branché à votre stack existante, sans rien casser.' },
        ...
        'la1.cat': { en: 'Data & Analytics', fr: 'Data & Analytics' },
        'la1.date': { en: 'Jul 15, 2026', fr: '15 juillet 2026' },
        'la1.title': { en: 'Enterprise AI agents: the data isn\'t ready', fr: 'Agents IA en entreprise : la donnée n\'est pas prête' },
        'la1.lead': { en: 'On July 8, 2026, Prime Intellect raised $130M to help companies train their own AI agents without depending on OpenAI or Anthropic. What build vs buy now means.', fr: 'Le 8 juillet 2026, Prime Intellect a levé 130 millions de dollars pour aider les entreprises à entraîner leurs propres agents IA, sans dépendre d\'OpenAI.' },
        'la2.cat': { en: 'Business & Growth', fr: 'Business & Growth' },
        'la2.date': { en: 'Jul 11, 2026', fr: '11 juillet 2026' },
        'la2.title': { en: 'Lyzr let an AI agent run its $100M fundraise', fr: 'Lyzr : un agent IA a mené sa levée de 100 millions' },
        'la2.lead': { en: 'On July 5, 2026, HubSpot reversed in four days a plan to share its 299,458 customers\' enrichment data by default. What the episode says about AI and data.', fr: 'Le 5 juillet 2026, HubSpot a annulé en quatre jours le partage par défaut des données d\'enrichissement de ses 299 458 clients. Ce que l\'affaire dit de l\'IA.' },
        'la3.cat': { en: 'CRM & Sales', fr: 'CRM & Sales' },
        'la3.date': { en: 'Jul 10, 2026', fr: '10 juillet 2026' },
        'la3.title': { en: 'AI agent costs push the enterprise into FinOps', fr: 'Coût des agents IA : l\'entreprise passe au FinOps' },
        'la3.lead': { en: 'On July 2, 2026, Anthropic gave Claude Enterprise spend caps and per-user cost attribution. As agentic bills blow past budgets, enterprise AI turns to FinOps.', fr: 'Le 2 juillet 2026, Anthropic a doté Claude Enterprise de plafonds de dépenses et d\'une attribution des coûts par utilisateur. L\'IA d\'entreprise passe au FinOps.' },
