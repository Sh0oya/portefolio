# Visible par les IA (scanner GEO) (EN)

> Source : https://mathieuhaye.fr/en/ai-visibility
> Copie du jumeau Markdown en/ai-visibility.md (source de verite editable).

---

---
title: "Is your website visible to AI? · Free test"
url: https://mathieuhaye.fr/en/ai-visibility
language: en
alternate: https://mathieuhaye.fr/visible-par-les-ia
description: "Test in 30 seconds whether ChatGPT, Perplexity and AI search can read AND cite your website. Get a score, a clear verdict, and what you stand to gain. Free."
---
...
Free interactive test: on the page, you enter your website URL, pick your platform (WordPress, 100% code / custom, Shopify, Wix, Webflow, Framer or other), and the scanner reads your page the way an AI would: crawler access, structure, data, citation files. You get an instant score out of 100, a verdict, three axis scores (Visible, Citable, Agent-ready), a signal-by-signal checklist of what AI sees, and a projection of the score you could reach after fixes. The full signal-by-signal report is emailed to you on request.
...
- Nearly half of SME sites are **unreadable to AI**: content loaded in JavaScript, crawlers blocked, zero structured data.
- **GEO** (Generative Engine Optimization) is to answer engines what SEO was to Google: it decides whether an AI cites you, or cites your competitor.
- Three layers matter: being **visible** (AI reaches the content), **citable** (it can attribute an answer to you), **agent-ready** (AI assistants can act on your site).
- The test is free, the score is instant, and it tells you exactly what is capping your site.

## What is AI visibility, and why it changes everything
...
## How do you know if ChatGPT can read your site?
...
## Why AI does not cite your site yet
...
### What is the difference between AI visibility and classic Google SEO?
...
### Can AI read a WordPress, Shopify, Wix, Webflow or Framer site?
...
### Who is behind this AI visibility test?

Mathieu Haye, a développeur freelance spécialisé IA et automatisation in Paris specialising in AI visibility, GEO and custom development. The test is free and diagnostic; if you want the fixes done for you, let's talk.

## Next step

Now you know where you stand. To go from "invisible" to "cited by AI", [see how we work together](https://mathieuhaye.fr/en/collaboration), automate it all with [Biencite](https://www.biencite.fr/), my AI-visibility tool that generates and deploys the fixes and tracks your citations, ask [my AI agent](https://mathieuhaye.fr/#agent), or browse the [journal](https://mathieuhaye.fr/blog/en/) on applied AI and GEO.
